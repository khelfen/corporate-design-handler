...
setup(
    ...
    description="Corporate design handler to generate color maps for plotting with python.",
    ...
    packages=find_packages(include=['corporate_design_handler', 'corporate_design_handler.*']),
    test_suite='tests',
